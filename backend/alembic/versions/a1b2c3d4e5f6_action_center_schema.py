...
def upgrade() -> None:
    ...
    with op.batch_alter_table('village_acceptance', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('ict_final', sa.Boolean(), server_default=sa.text('0'), nullable=False))
        ...
        batch_op.add_column(sa.Column('cra_final', sa.Boolean(), server_default=sa.text('0'), nullable=False))
